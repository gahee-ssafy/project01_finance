...
# 백엔드 3/3 기준, accounts에서 urls, models, serializer, views 구현함.

# 프론트는 전체 리팩토링 예정. 레퍼런스 하나 잡아서 그대로 구현할 예정, back 기능 다 되면 그때 과업시작
...
- [미결] 코사인 유사도 검색
- [미결] 데이터베이스 학습: 도커연습(miniconda포함) 기능별 테이블 정리 - 목록 생성시 새로운 테이블로 관리 요망
